...
import { ArrowRight, ArrowUpRight, Briefcase, Code2, HeartHandshake, Megaphone, ShieldCheck, User } from "lucide-react";
      ...
      <Container size="xl">
        <div className="space-y-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#1c1c27] pb-8">
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">
                Structured for technical execution, institutional governance, and high-quality creative output across RIT.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {activeDept && (
              <div className="lg:col-span-6 bg-[#09090e] border border-[#1f1f2c] rounded-2xl p-8 sm:p-10 space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-4 relative z-10">
                  <div className="flex items-center justify-between border-b border-[#1c1c27] pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="text-xs font-mono text-zinc-500 uppercase">Division Inspector</span>
                        <h4 className="text-xl font-bold text-white uppercase">{activeDept.name}</h4>
                      </div>
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-[#101017] border border-[#222230] space-y-2 relative z-10">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-base font-bold text-white">{activeLead.name}</div>
                          <div className="text-xs text-blue-400 font-mono">{activeLead.role}</div>
                        </div>
                      </div>
                      <span className="text-[11px] font-mono text-zinc-500">{activeLead.tenure}</span>
                    </div>
                  </div>
                )}
                ...
                <div className="pt-2 border-t border-[#1c1c27] flex items-center justify-between relative z-10">
                  <Link href="/team" className="text-xs text-blue-400 hover:text-blue-300 font-mono font-semibold flex items-center gap-1.5">
